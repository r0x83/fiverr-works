...
contract BABYCAKE is ERC20, Ownable {
    ...
    uint256 public CAKERewardsFee = 7;  // change this to 10%
    uint256 public liquidityFee = 3;    //change this to 5% -- only for selling
    uint256 public burningFee = 2.5;    // remove this - no marketing fee
    uint256 public totalFees = CAKERewardsFee.add(liquidityFee).add(burningFee);
