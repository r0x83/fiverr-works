...
contract BUSDC is ERC20, Ownable {
    ...
    // buy fees
    uint256 public buyDividendRewardsFee = 12;
    ...
    // sell fees
    uint256 public sellDividendRewardsFee = 12;
    ...
    constructor() ERC20("BUSDClassic", "BUSDC") {
        dividendTracker = new TokenDividendTracker();

        teamWallet = 0x78CF41247a42768bA77BF019c653F8E99E4163fb;
        lotteryWallet = 0x78CF41247a42768bA77BF019c653F8E99E4163fb;
        marketingWallet = 0x78CF41247a42768bA77BF019c653F8E99E4163fb;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "BUSDC: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "BUSDC: The new dividend tracker must be owned by the BUSDC token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BUSDC: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BUSDC: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "BUSDC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BUSDC: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "BUSDC: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "BUSDC: Cannot update gasForProcessing to same value"
        );
...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor()
        DividendPayingToken("BUSDC_Dividend_Tracker", "BUSDC_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "BUSDC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BUSDC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BUSDC contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "BUSDC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "BUSDC_Dividend_Tracker: Cannot update claimWait to same value"
        );
